              ...
              <table class="table table-striped table-hover">
                ...
                <tbody>
                  <tr v-for="subject in subjects" :key="subject.id">
                    ...
                    <td>
                      <span v-if="subject.description">{{ subject.description.substring(0, 100) }}{{ subject.description.length > 100 ? '...' : '' }}</span>
                      <span v-else class="text-muted">No description</span>
                    </td>
                    <td>
                      <span class="badge bg-info">{{ subject.chapter_count || 0 }} chapters</span>
                    </td>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">{{ editingSubject ? 'Edit Subject' : 'Create Subject' }}</h5>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p class="text-warning">This action cannot be undone and will also delete all associated chapters and quizzes.</p>
          </div>
          <div class="modal-footer">
  ...
  setup() {
    ...
    const saveSubject = async () => {
      ...
      try {
        ...
        errorMessage.value = error.response?.data?.message || 'Failed to save subject'
      } finally {
        saving.value = false
      }
    }
