...
class Quiz(BaseModel):
    ...
    time_duration = db.Column(db.String(8), nullable=False)  # HH:MM:SS format as string
    ...
    def convert_to_json(self):
        return {
            ...
            'subject_id': self.chapter.subject_id if self.chapter and self.chapter.subject else None,
